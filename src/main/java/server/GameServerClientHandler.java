...
*/
    ...
    public GameServerClientHandler(Socket socket, List<GameServerClientHandler> clients) {
        System.out.println("[SERVER_CLIENT_HANDLER]: server.GameServerClientHandler created");
        this.socket = socket;
...
*/
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("[GameServerClientHandler]: " + this.getPlayerName() +" left the game");
            e.printStackTrace();
        }
         */
