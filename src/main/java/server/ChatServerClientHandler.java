...
public class ChatServerClientHandler implements  Runnable {
    ...
    public ChatServerClientHandler(Socket socket, List<ChatServerClientHandler> clients) {
        System.out.println("[SERVER_CLIENT_HANDLER]: server.ChatServerClientHandler created");
        this.socket = socket;
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("[ChatServerClientHandler]: " + this.getPlayerName() +" left the game");
            e.printStackTrace();
        }
